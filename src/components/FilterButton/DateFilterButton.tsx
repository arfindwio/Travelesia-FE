  ...
  return (
    <div className="flex w-full items-center gap-2 px-5">
      {dates.map((date, index) => {
        ...
        return (
          <>
            <div key={index} className="group flex w-[12%] cursor-pointer flex-col gap-2 rounded-lg py-2 text-center hover:bg-primary-3 hover:text-neutral-5">
            ...
            {index < 7 ? <div className="text w-fit text-2xl font-thin text-neutral-3">|</div> : null}
          </>
        );
      })}
    </div>
