  ...
  return (
    <>
      ...
      <div className="flex w-full items-center justify-between sm:pt-28">
        <div className="bg-primary-3 sm:w-[2%] sm:py-16 xl:w-[15%]"></div>
        <div className="flex h-[10rem] w-full overflow-hidden bg-secondary-3 sm:h-auto sm:rounded-[20px]">
          <div className="my-auto w-1/2 pl-8 sm:w-2/6 sm:py-16 sm:pl-10 md:pl-16">
            <h1 className="text-2xl font-extrabold italic sm:text-3xl md:text-4xl">
              Discount For Now
              <span className="font-bold not-italic text-primary-3"> 85%</span>
            </h1>
          </div>
        ...
        <div className="bg-primary-4 sm:w-[2%] sm:py-16 xl:w-[15%]"></div>
      </div>
      <div className="relative left-1/2 top-44 w-[95%] -translate-x-1/2 -translate-y-1/2 transform sm:top-24 sm:w-[90%] md:w-[85%] xl:top-16 xl:w-[65%]">
        <FlightFilterCard />
      </div>
